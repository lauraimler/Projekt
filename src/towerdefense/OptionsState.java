...
public class OptionsState extends BasicGameState {
	...
	public void init(GameContainer container, StateBasedGame game) throws SlickException {
    	...
    	background.addComponent(new ImageRenderComponent(new Image("/assets/background.jpeg"))); // Bildkomponente
    	...
    	esc_pressed.addAction(new ChangeStateAction(TowerDefense.MAINMENU_STATE));
    	...
    	mouse_Clicked.addAction(new Action() {
			...
			public void update(GameContainer gc, StateBasedGame sb, int delta,
				...
				Entity tower = new Entity("tower");
				tower.setPosition(new Vector2f(gc.getInput().getMouseX(),gc.getInput().getMouseY()));
				
				try {
					// Bild laden und zuweisen
					tower.addComponent(new ImageRenderComponent(new Image("assets/tower.png")));
				} catch (SlickException e) {
					System.err.println("Cannot find file assets/tower.png!");
					e.printStackTrace();
				}
		    	...
		    	//lse.addAction(new ChangeStateAction(TowerDefense.MAINMENU_STATE));
		    	
		    	tower.addComponent(lse);
